//
//  TournamentInviteViewController.m
//  Chosen
//
//  Created by Deepayan on 23/04/15.
//  Copyright (c) 2015 appsbee. All rights reserved.
//

#import "TournamentInviteViewController.h"
...
@interface TournamentInviteViewController ()<MKMapViewDelegate,CLLocationManagerDelegate,UIAlertViewDelegate,AnnotationViewControllerDelegate>
{
...
@implementation TournamentInviteViewController
...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id <MKAnnotation>)annotation
{
    ...
    annButton.titleLabel.text=@"Invite";
    pinView.rightCalloutAccessoryView=annButton;
    [annButton addTarget:self action:@selector(click) forControlEvents:UIControlEventTouchUpInside];
    [wrldMapView addAnnotation:annotation];
...
-(void)didAnnonationInvitePressedWithUser:(ModelUser *)userTapped
{
    if (annotationViewController.isCallOutOpen)
    {
        UIView *vw=annotationViewController.view;
